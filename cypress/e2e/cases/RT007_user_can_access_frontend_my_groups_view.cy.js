describe('RT007_user_can_access_frontend_my_groups_view', () => {
  ...
  // Login to AutoLink Frontend and confirm my-groups view.
  it('Login to AutoLink Frontend and confirm my-groups view.', () => {
    cy.session(
      'login_to_autoLink_frontend_confirm_my_groups_view',
      () => {
        ...
        cy.visit('/autolink/groups')

        // Confirm expected dom elements exist.
        cy.get('dt-tile.churches')
