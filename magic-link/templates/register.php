...
<div class="container register">
    <dt-tile>
        ...
        <form action="<?php echo esc_attr( $form_action ) ?>" method="POST">
            ...
            <dt-text name="name" placeholder="<?php _e( 'Name', 'dt_autolink' ); ?>" value="" required></dt-text>
            <dt-text name="username" placeholder="<?php _e( 'Username', 'dt_autolink' ); ?>" value="" required></dt-text>
            <dt-text name="email" placeholder="<?php _e( 'Email', 'dt_autolink' ); ?>" value="" required></dt-text>
            <dt-text name="password" placeholder="<?php _e( 'Password', 'dt_autolink' ); ?>" value="" required></dt-text>
            <dt-text name="confirm_password" placeholder="<?php _e( 'Confirm Password', 'dt_autolink' ); ?>" value="" required></dt-text>
